...
class f3Vector
{
	...
	public:
		...
		f3Vector crossProduct(f3Vector b);
...
class f2Vector {// most used for texture coordination
public:
	float u;
	float v;
	f2Vector::f2Vector() {
	...
	f2Vector::f2Vector(float fx, float fy) {//NOTE:If I have two constrcutor you can make them do the same thing,like settin all as 0
		u = fx;
		v = fy;

	}
};
class Int2Vector {// most used for texture coordination
public:
	int x;
	int y;
	...
	Int2Vector::Int2Vector(int fx, int fy) {//NOTE:If I have two constrcutor you can make them do the same thing,like settin all as 0
		x = fx;
		y = fy;
